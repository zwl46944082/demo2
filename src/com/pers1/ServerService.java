 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://day05/", wsdlLocation = "http://localhost:9001/Service/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://day05/", "ServerService");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://day05/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://day05/", "ServerPort"), Server.class, features);
    }
